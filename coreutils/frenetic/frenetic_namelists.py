...
class FreneticNamelist():
   ...
   def __init__(self):
      ...
      self.files = {
                     "common_input.inp": ["PRELIMINARY", "COREGEO", "COMMNUM", "ADDTH", "OMP"],
                     "NEinput.inp": ["CONTROL", "MESHNE", "NUMERICS1", "NUMERICS2", "NUMERICS3",
                                    "OUTPUT0NE", "OUTPUTNE"],
                     "THinput.inp": ["NUMERICS", "IBCONDITIONS", "COUPLING", "OUTPUTTH", 
                                     "SENSOR_RAD"],
      ...
      self.namelists = {
                           ...
                           "COMMNUM": ["nElems", "xLengt", "iTyMsh", "nRef", "nElRef", "xBRefi", "xERefi",
                                       "iAdapTime", "tEnd", "StpMin", "StpMax", "StpMinSteady"], # "TrefBeg", "TrefEnd" 
                           "ADDTH": ["MaxNRadNode", "nMaxBCchange"],
                           "OMP": ["nCPUTH", "nCPUNE"],
                           # TH input
                           "NUMERICS": ["ISTISC", "DTTISC", "TolToSteady", "method", "iQFun", "xQbeg", 
                                        "xQend", "dxQ0", "Q0", "tQbeg", "tQend", "tolTemp", "URTFLU", "URTPIN",
                                       "tolPres", "underTemp", "underPress", "frozencoeff", "nMaxIter", 
                                       "sthMax", "errRelTime", "qPinDotStepIncrement", "kLocX", "underFlux",
                                       "powtot0"
                                       ],
                           "IBCONDITIONS": ["inTial", "temInl", "temOut", "preInl", "preOut", "mdtInl", 
                                            "temIni", "eneBound", "masBound", "momBound", "mdtInlBiB", 
                                            "preInl"],
                           ...
                           "COMMONS": ["iHA"],
                           "THERMALHYDRAULIC": [
                                                "nFuelX", "nNonHeatedX", "iFuelX", "dFuelX", "dFuelInX", 
                                                "dFuelNfX", "RCoX", "RCiX", "ThickGasX", "ThickBoxX", 
                                                "ThickClearX", "InBoxInsideX", "InBoxOutsideX", "dWireX",
                                                "pWireX", "PtoPDistX", "FPeakX", "QBoxX",
                                                "BoxMatX", "iHpbPinX", "iTyFrictX", "iChCouplX", 
                                                "iMatX", "iRadHom", "iBiBX", "iCRadX", "NonFuelMat", "iCladX",
                                                "iGapX", "MaterHX", "HeatGhX"
                                               ],
                        }
      ...
      self.kw_descr = {
                           ...
                           "iRadHom": "Flag for homogeneous (=1) or heterogeneous (=2) radial geometry",
                           "RCoX": "Outer cladding radius for fuel rods in [m]. Even if iRadHom=0, the value is used to perform preliminary calculations, so take it equal to half of fuel diameter",
